...
public class DialogoAdmAdministrador extends javax.swing.JDialog {
     ...
     */
    public DialogoAdmAdministrador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Administrativos"));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoAdmAdministrador dialog = new DialogoAdmAdministrador(new javax.swing.JFrame(), true);
