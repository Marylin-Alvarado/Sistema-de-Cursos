    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case 0:
                return (rowIndex + 1);
            case 1:
                return (ast != null) ? ast.getUsuario().toString() : "NO DEFINIDO";
            case 2:
                return (ast != null) ? (ast.getApellidos() + " " + ast.getNombres()) : "NO DEFINIDO";
            case 3:
                return (ast != null) ? ast.getCiclos() : "NO DEFINIDO";
            case 4:
                return (ast != null) ? ast.getEstado(): "NO DEFINIDO";
            case 5:
